...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:border-light dark:bg-dark flex flex-col justify-between">
      ...
      <div>
        <Link href={link}>
          <h2 className="capitalize text-2xl font-bold font-pacifico my-2 mt-4 hover:underline xs:text-lg">
            {title}
          </h2>
        </Link>
        <p className="text-sm font-pacifico mb-2 xs:text-xs">{summary}</p>
