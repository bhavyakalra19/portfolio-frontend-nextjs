  ...
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-gray-200 shadow-black shadow-2xl p-12 relative dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        <span className="text-primary font-pacifico text-xl dark:text-primaryDark xs:text-base">
          {type}
        </span>
        <Link
          href={link}
        ...
        <p className="my-2 font-pacifico text-dark dark:text-light sm:text-[fontSize: 5px]">
          {summary}
        </p>
    ...
    >
      <div>
        ...
        <div className="w-full flex flex-col items-start justify-between mt-4 sm:items-center">
          <span className="text-primary font-pacifico text-xl dark:text-primaryDark lg:text-lg md:text-base sm:text-xs">
            {type}
          </span>
          <Link
            href={link}
          ...
          <p className="my-2 font-pacifico text-dark dark:text-light sm:text-xs sm:hidden">
            {summary}
          </p>
        </div>
      </div>
