          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <AnimatedText
                ...
                className="!text-xl font-pacifico my-6 xl:!text-5xl lg:text-center lg:!text-4xl md:!text-2xl sm:!text-xl"
              />
              <div className="flex items-center mt-2">
                ...
                <button
                  ...
                  className="ml-4 text-lg font-pacifico capitalize text-dark underline dark:text-light"
                >
                  Copy Email
                </button>
              </div>
              {showCopyText === "" ? undefined : (
                <AnimatedText
                  text={showCopyText}
                  className=" !text-xs font-pacifico mt-6 dark:text-light text-dark z-10 "
                />
              )}
